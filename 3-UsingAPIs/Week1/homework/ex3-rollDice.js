...
/**
 *  ? Is the problem been solved? NO.
 *
 *  I just followed the instructions, but this alone doesn't solve the problem.
 *  The code passed the test.
 *  I wasn't sure if I should modify the main code or not
 *  I'll leave it to the review discussion.
 */
